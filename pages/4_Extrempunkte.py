...
try:
    ...
    if zeichnen:
        ...
        st.pyplot(plotten([f], punktePlot, xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax, draw_grid=gitter, draw_ticks=skala, legende=legend, dateiname='graph-ableitung', textgroesse=textgroesse))
        try:
